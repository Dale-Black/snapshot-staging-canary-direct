...
# ╔═╡ ae000001-0000-4000-8000-000000000001
begin
    using SnapshotStagingUnavailableImport
end

# ╔═╡ ae000002-0000-4000-8000-000000000002
using Statistics

# ╔═╡ ae000014-0000-4000-8000-000000000014
using PlutoUI: TableOfContents

# ╔═╡ ae000003-0000-4000-8000-000000000003
...
begin
    ...
    Base.show(io::IO, ::MIME"text/html", s::CanarySlider) =
        write(io, "<input id=import-isolation-slider type=range value=1 min=1 max=$(s.max)>")
    Bonds.initial_value(::CanarySlider) = 1
    Bonds.possible_values(s::CanarySlider) = 1:s.max
end
...
The deliberately unavailable import above is unrelated to this slider. It must
not prevent Snapshot from compiling the valid `Statistics`-based output below.
"""
...
manifest_format = "2.0"
project_hash = "83c0fac85423053e453d4ea6196d6c3a5b0e1d3b"
